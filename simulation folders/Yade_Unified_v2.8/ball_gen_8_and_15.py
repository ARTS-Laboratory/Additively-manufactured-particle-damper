...
# SAMUEL ADDED CODE
# This originally was meant for use in the dynamic ball velocity function, but I ended up using a different method.
# Left in case we need it later, but as of v2.8 it is not being used.
#-----------------
def simSpeedTracker():
...
def ballvel():
        ...
        if indent:
                ...
                if ballLoc == "left":
                        ...
                        # This is meant to dynamically change the indent sphere velocity based on distance from target
                        # location. We need this because sometimes the sphere would overshoot the target location and
                        # result in a larger indent than intended. Accuracy of the indent varied based on simulation
                        # speed, so smaller scale simulations were less accurate. Using this code, indent accuracy is
                        # much greater and can be controlled somewhat. Increasing the smoothingFactor will increase
